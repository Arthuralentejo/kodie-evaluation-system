...
from app.models.api import AdminResultDetail, AdminResultSummary, AnalyticsResult, RankingPage
from app.repositories.assessment_repository import AssessmentRepository
from app.services.analytics_service import AnalyticsService
from app.services.ranking_service import RankingService

router = APIRouter(prefix="/admin", tags=["admin"], dependencies=[Depends(get_admin_context)])
...
async def list_results(
    ...
    repo: AssessmentRepository = Depends(_get_assessment_repository),
):
    logger.info(
        build_log_message(
    ...
    for doc in docs:
        ...
        results.append(AdminResultSummary(
...
async def ranking_by_type(
    ...
    result = await ranking_service.rank_by_type(assessment_type=assessment_type, page=page, page_size=page_size)
    logger.info(
        build_log_message(
